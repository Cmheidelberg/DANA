...
public class JsonWriter {
	...
	public void writeJson(String path) {
		...
		System.out.println(keyValueStringFormatter(keys));
		String toWrite = keyValueStringFormatter(keys);
	...
	/**
	 * Creates a (formatted) string representation of a json object from the given list of key/value pair objects
	 * 
	 * ie: 
	 * {
	 *    "key1": "value1",
...
/**
 * Store a relation of key, value pair. Sometimes the value will be empty since much of the metadata will
 * be entered from the user. 
 */
class KeyValuePair {
